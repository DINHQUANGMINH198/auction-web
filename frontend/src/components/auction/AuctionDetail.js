      ...
      <Row className="my-5">
        ...
        <Col lg="3" className="rounded border bg-light pb-5 mr-2">
          <div className="d-flex justify-content-between mt-3">
            ...
            <h5 className="text-danger">{getTheHighestBid(auctionItem.id) ===0?auctionItem.initial_price:getTheHighestBid(auctionItem.id)} <span className="text-secondary">VND</span></h5>
          </div>
          <hr />
          <div className="d-flex justify-content-between mt-3">
                ...
                if (bid.auction_id === auctionItem.id) {
                  return (
                    <div className="d-flex justify-content-between" key={'sub' + bid.id + i}>
                      ...
                      <h6 className="text-primary">{bid.bid} <span className="text-secondary">VND</span></h6>
                    </div>       
                  )
                }
              })
