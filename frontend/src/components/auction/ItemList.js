          ...
          <Card className="card">
            ...
            <CardBody>
              ...
              <div className="d-flex justify-content-between mt-3">
                <CardText><span className="text-danger">{getAuctionBids(item.id) !==0?getAuctionBids(item.id):item.initial_price}</span><span className="text-secondary"> VND</span></CardText>
